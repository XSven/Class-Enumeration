...
Each enum subclass has a getter method (an object method) C<name()>, that
returns the name of the enum object, exactly as declared.

Each enum subclass has a getter method (an object method) C<ordinal()>, that
returns the ordinal of the enum object (its position in its declaration,
...
Each enum subclass has a factory method (a class method) C<value_of( $name)>,
